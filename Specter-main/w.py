...
os.system( "title Discoulti Tool [Premium]" )
...
while True: #infinite loop
    RPC.update(
        large_image = "App", #name of your asset
        large_text = "Disclouti Tool",
        details = "En cours d'utilisation...",
        state = "By Mioultigaming#1001",
        start = start,
        buttons = [{"label": "Discord du Tool", "url": ""}] #up to 2 buttons
    )
    time.sleep(10)
